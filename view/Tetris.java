...
public class Tetris extends JFrame {
    ...
    contentPanel.setBorder(BorderFactory.createLineBorder(Color.BLACK, 8)); 
    contentPanel.setBackground(Color.WHITE);

    // 2. 文字標籤：加上 EmptyBorder 來把文字往下推
    // BorderFactory.createEmptyBorder(上, 左, 下, 右)
    JLabel label = new JLabel("遊戲結束！方塊已堆滿。", SwingConstants.CENTER);
    ...
    JButton backBtn = new JButton("回到主畫面");
